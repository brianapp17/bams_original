...
interface AddMedicationAdministrationDuplicateFormProps {
  onSave: (formData: MedicationAdministrationDuplicateFormData) => void;
  onCancel: () => void;
}

interface MedicationAdministrationDuplicateFormData {
...
const AddMedicationAdministrationDuplicateForm: React.FC<AddMedicationAdministrationDuplicateFormProps> = ({ onSave, onCancel }) => {
  const [formData, setFormData] = useState<MedicationAdministrationDuplicateFormData>({
    medicationName: '',
    dosageValue: '',
    dosageUnit: '',
    route: '',
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-sm">
        <h2 className="text-xl font-bold mb-4 text-teal-700 border-b pb-2">Nuevo Medicamento Duplicado</h2>
...
export default AddMedicationAdministrationDuplicateForm;
